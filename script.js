...
function foodPage() {
    ...
    card.innerHTML = `
        ...
        <button class="food-btn" onclick="finish('🍕 Pizza')">
            🍕 Pizza
        </button>

        <button class="food-btn" onclick="finish('🍝 Pasta')">
            🍝 Pasta
        </button>

        <button class="food-btn" onclick="finish('🍣 Sushi')">
            🍣 Sushi
        </button>

        <button class="food-btn" onclick="finish('🍨 Ice Cream')">
            🍨 Ice Cream
        </button>

        <button class="food-btn" onclick="finish('☕ Coffee')">
            ☕ Coffee
        </button>
    `;
}
